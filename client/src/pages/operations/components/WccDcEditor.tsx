                  ...
                  <form onSubmit={handleDcSubmit} className="w-full md:w-[280px] bg-white p-5 border-r border-slate-200 overflow-y-auto space-y-5 flex flex-col justify-between print:hidden">
                    <div className="space-y-5">
                      ...
                      <div className="space-y-4 text-xs">
                        ...
                        {/* 4. Copy To store list — visible only for multi-store ABFRL estimates */}
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="flex gap-1.5">
                            <button
                              ...
                              onClick={() => { handleApplyCurrentPhotosToSelectedWccs && handleApplyCurrentPhotosToSelectedWccs(bulkSelectedStoreIds); }}
                              className="flex-1 h-8 border border-purple-200 bg-white hover:bg-purple-50 disabled:opacity-40 text-purple-700 text-[10px] font-bold rounded transition flex items-center justify-center gap-1"
                            >
                              <Copy className="w-3 h-3" /> Copy To Selected ({bulkSelectedStoreIds.length})
                            </button>
                            <button
                              type="button"
                              ...
                              onClick={() => {
                                ...
                                const count = activeWccsForEditor.length - 1;
                                if (count === 0) { alert("No other stores to copy to."); return; }
                                if (!confirm(`Copy photos to all ${count} other store WCCs?`)) return;
