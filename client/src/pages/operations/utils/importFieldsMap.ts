...
export const importFieldsMap: Record<string, ImportFieldDef[]> = {
  ...
  stores: [
    { label: "Store Site Name", key: "name", required: true, synonyms: ["store_name", "store name"] },
    { label: "Client Name (for auto lookup)", key: "clientName", required: true, synonyms: ["client_name"] },
    { label: "Brand Name (for auto lookup)", key: "brandName", required: true, synonyms: ["brand_name"] },
    { label: "Store Code", key: "storeCode", synonyms: ["store_code"] },
    { label: "Location City", key: "location" },
    { label: "Address", key: "address", synonyms: ["full_address"] },
    { label: "Contact Person", key: "contactPerson", synonyms: ["contact_person"] },
    { label: "Contact Phone", key: "contactPhone", synonyms: ["contact_number", "contact_phone"] },
    { label: "City", key: "city" },
    { label: "State Name", key: "state" },
    { label: "State Code", key: "stateCode", synonyms: ["state_code"] },
    { label: "Region / Zone", key: "regionZone", synonyms: ["region_zone", "region/zone", "region"] },
    { label: "Alternative Contact", key: "contact" },
    { label: "Internal Client ID (optional, reference only)", key: "clientId", reference: true, synonyms: ["client_id"] },
    { label: "Internal Brand ID (optional, reference only)", key: "brandId", reference: true, synonyms: ["brand_id"] },
    { label: "Internal Store ID (optional, reference only)", key: "id", reference: true, synonyms: ["store_id"] },
  ],
  products: [
